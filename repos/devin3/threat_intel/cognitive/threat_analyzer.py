...
# This module is designed for analyzing text from legitimate security research
# sources (e.g., threat reports, security blogs). Accessing dark web forums
# or illicit marketplaces can have serious legal consequences and expose you
# to harmful material. This tool does NOT provide any functionality to
# connect to or scrape such sources.
# ----------------------------------------
