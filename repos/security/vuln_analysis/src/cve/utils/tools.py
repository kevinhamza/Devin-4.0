...
from .sbom_parsers.sbom_parser import SBOMParser
from .sbom_parsers.syft_parser import Syft

logger = logging.getLogger(f"morpheus.{__name__}")

SBOM_PICKER: dict[str, type[SBOMParser]] = {Syft.get_name(): Syft}
...
class SBOMChecker:
    ...
    def __init__(self, sbom_map: dict[str, str]):
        ...
        # Lowercase all keys in the SBOM map and strip whitespace
